#ifndef OMP_PUT_QUEEN_V3_H
#define OMP_PUT_QUEEN_V3_H

#include "put_queen.h"

/**
 * Version parallèle de la fonction put_queen basée sur l'utilisation de tâches.
 *
 ...
 */
unsigned long omp_put_queen_v3(int chessboard[],
                               const int dim,
                               const int lin,
                               const int col,
                               const int threads);
